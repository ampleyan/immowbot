    ...
    def save_listing(self, run_id, listing):
        ...
        if previous:
            ...
            retained_enrichment = {
                ...
                and previous_payload.get(key) is not None
                and previous_payload.get(key) != ""
                and not (isinstance(previous_payload.get(key), str) and not previous_payload.get(key).strip())
            }
